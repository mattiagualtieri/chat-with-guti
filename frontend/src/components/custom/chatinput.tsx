...
const suggestedActions = [
    {
        ...
        label: 'your biggest achievement so far',
        action: 'Tell me what is Mattia Gualtieri\' biggest professional achievement so far',
    },
    {
        title: 'What are your',
        label: 'technical strengths?',
        action: 'Tell me about Mattia\'s technical skills, what are his technical strengths?',
    },
];
